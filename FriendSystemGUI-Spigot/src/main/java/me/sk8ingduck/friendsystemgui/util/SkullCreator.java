...
public class SkullCreator {
	...
	public static ItemStack createSkull(String skullType, String displayName, String... lore) {
		...
		ItemStack item;
		try {
			item = new ItemStack(Material.valueOf(skullType));
		} catch (IllegalArgumentException e) {
			item = new ItemStack(Material.valueOf("SKULL_ITEM"), 1, (byte) (skullType.equals("SKELETON_SKULL") ? 0 : 3));
		}
	...
	public static ItemStack createPlayerSkull(String displayName, String... lore) {
		return createSkull("PLAYER_HEAD", displayName, lore);
	}
	...
	public static ItemStack itemFromName(String name) {
		return itemWithName(createPlayerSkull(), name);
	}
	...
	public static ItemStack itemFromUuid(UUID id) {
		return itemWithUuid(createPlayerSkull(), id);
	}
	...
	public static ItemStack itemFromUrl(String url) {
		return itemWithUrl(createPlayerSkull(), url);
	}
	...
	public static ItemStack itemFromBase64(String base64) {
		return itemWithBase64(createPlayerSkull(), base64);
	}
	...
	public static void blockWithName(Block block, String name) {
		...
		org.bukkit.block.Skull state = (org.bukkit.block.Skull) block.getState();
