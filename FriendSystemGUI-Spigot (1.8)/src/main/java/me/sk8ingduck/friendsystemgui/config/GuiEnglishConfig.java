...
public class GuiEnglishConfig extends GuiConfig {
	...
	public void loadValues() {
		...
		items.put("guiItem", ItemUtil.createItem(Material.SKULL, (byte) 3, "§aFriends Menu"));
		...
		items.put("gui.mainMenu.item.settings", ItemUtil.createItem(Material.REDSTONE_TORCH_ON, "§cSettings"));
		items.put("gui.mainMenu.item.requests", ItemUtil.createItem(Material.BOOK_AND_QUILL, "§bFriend Requests"));
		...
		items.put("gui.settingsMenu.item.toggleNotifies", ItemUtil.createItem(Material.WOOD_DOOR, "§6Toggle Join/Leave notifications"));
		...
		items.put("gui.settingsMenu.item.invitesOn", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.LIME.getData(), "§6Friend requests are now §aallowed"));
		items.put("gui.settingsMenu.item.invitesOff", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.RED.getData(), "§6Friend requests are now §cdisallowed"));
		items.put("gui.settingsMenu.item.notifiesOn", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.LIME.getData(), "§6Join/Leave notifications are now §aenabled"));
		items.put("gui.settingsMenu.item.notifiesOff", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.RED.getData(), "§6Join/Leave notifications are now §cdisabled"));
		items.put("gui.settingsMenu.item.msgsOn", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.LIME.getData(), "&6Private messages are now &aallowed"));
		items.put("gui.settingsMenu.item.msgsOff", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.RED.getData(), "&6Private messages are now &cdisallowed"));
		items.put("gui.settingsMenu.item.jumpOn", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.LIME.getData(), "&6Jumping is now &aallowed"));
		items.put("gui.settingsMenu.item.jumpOff", ItemUtil.createItem(Material.STAINED_GLASS_PANE, DyeColor.RED.getData(), "&6Jumping is now &cdisallowed"));

		items.put("gui.selectedPlayerMenu.item.back", Skull.BACK.getSkull("&cBack"));
		items.put("gui.selectedPlayerMenu.item.addFriend", ItemUtil.createItem(Material.GREEN_RECORD, "&6Send friend request"));
		items.put("gui.selectedPlayerMenu.item.removeFriend", ItemUtil.createItem(Material.BARRIER, "&cRemove friend"));
		items.put("gui.selectedPlayerMenu.item.acceptFriend", ItemUtil.createItem(Material.GREEN_RECORD, "&6Accept friend request"));
